...
# WIDTH parameter
set_property display_name {TDATA Width} [ipgui::get_guiparamspec -name "WIDTH" -component [ipx::current_core] ]
set_property tooltip {} [ipgui::get_guiparamspec -name "WIDTH" -component [ipx::current_core] ]
set_property widget {textEdit} [ipgui::get_guiparamspec -name "WIDTH" -component [ipx::current_core] ]
set_property value 64 [ipx::get_user_parameters WIDTH -of_objects [ipx::current_core]]
set_property value 64 [ipx::get_hdl_parameters WIDTH -of_objects [ipx::current_core]]
